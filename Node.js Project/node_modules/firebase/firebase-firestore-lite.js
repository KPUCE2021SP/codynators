import { _getProvider, getApp, _removeServiceInstance, _registerComponent, registerVersion, SDK_VERSION } from 'https://www.gstatic.com/firebasejs/9.0.1/firebase-app.js';
 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.0.1/firebase-app.js#FirebaseApp} with which the `Firestore` instance will
 * be associated.
 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.0.1/firebase-app.js#FirebaseApp} instance that the returned `Firestore`
...
}), "PUBLIC" /* PUBLIC */)), registerVersion("firestore-lite", "3.0.1", "node");
