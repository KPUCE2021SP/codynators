...
import { base64 as a, createMockUserToken as h, getModularInstance as l } from "@firebase/util";
 ...
 * limitations under the License.
 */
const w = new u("@firebase/firestore");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const I = "ok", T = "cancelled", A = "unknown", P = "invalid-argument", R = "deadline-exceeded", V = "not-found", N = "already-exists", D = "permission-denied", $ = "unauthenticated", F = "resource-exhausted", S = "failed-precondition", q = "aborted", x = "out-of-range", O = "unimplemented", C = "internal", L = "unavailable", U = "data-loss";
 ...
 */ class W {
    constructor(t, n, e) {
        this.t = t, this.i = n, this.o = e, this.type = "FirstParty", this.user = f.FIRST_PARTY;
    }
    get authHeaders() {
        const t = {
 ...
 */ class J extends K {
     ...
     */    static fromString(...t) {
        ...
        const n = [];
        for (const e of t) {
            if (e.indexOf("//") >= 0) throw new j(P, `Invalid segment (${e}). Paths must not contain // in them.`);
 ...
 */ class X extends K {
     ...
     */    static fromServerFormat(t) {
        ...
        let e = "", r = 0;
        const s = () => {
            if (0 === e.length) throw new j(P, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
            n.push(e), e = "";
        };
        let i = !1;
        for (;r < t.length; ) {
            ...
            if ("\\" === n) {
                ...
                const n = t[r + 1];
                if ("\\" !== n && "." !== n && "`" !== n) throw new j(P, "Path has invalid escape sequence: " + t);
                e += n, r += 2;
 ...
 * limitations under the License.
 */ function nt(t, n, e) {
    if (!e) throw new j(P, `Function ${t}() cannot be called with an empty ${n}.`);
}
...
n) {
    ...
    t = t._delegate), !(t instanceof n)) {
        if (n.name === t.constructor.name) throw new j(P, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        {
            const e = st(t);
            throw new j(P, `Expected type '${n.name}', but it was: ${e}`);
        }
    }
    return t;
}
...
function ot(t, n) {
    if (n <= 0) throw new j(P, `Function ${t}() requires a positive number, but it was: ${n}.`);
}
...
function ft(t) {
    ...
    // https://github.com/googleapis/googleapis/blob/master/google/rpc/code.proto
      ...
      default:
        return t >= 200 && t < 300 ? I : t >= 400 && t < 500 ? S : t >= 500 && t < 600 ? C : A;
    }
}
...
class {
    ...
    l(t, n, e, r) {
        ...
        const i = {};
        return this.p(i, r), this.g(t, s, i, e).then((t => (p("RestConnection", "Received: ", t), 
        t)), (n => {
...
class _t {
     ...
     */
    n) {
        if (this.seconds = t, this.nanoseconds = n, n < 0) throw new j(P, "Timestamp nanoseconds out of range: " + n);
        if (n >= 1e9) throw new j(P, "Timestamp nanoseconds out of range: " + n);
...
/** Creates a deep copy of `source`. */ function Mt(t) {
    ...
    if (t.mapValue) {
        ...
        return bt(t.mapValue.fields, ((t, e) => n.mapValue.fields[t] = Mt(e))), n;
    }
    if (t.arrayValue) {
        const n = {
            arrayValue: {
 ...
 */ class Qt {
    ...
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, n) {
        return new Qt(t, 2 /* NO_DOCUMENT */ , n, Bt.empty(), 0 /* SYNCED */);
    }
    /**
     ...
     */    static newUnknownDocument(t, n) {
        return new Qt(t, 3 /* UNKNOWN_DOCUMENT */ , n, Bt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }
    /**
...
class Gt extends class {} {
     ...
     */    static create(t, n, e) {
        return t.isKeyField() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.R(t, n, e) : new Ht(t, n, e) : "array-contains" /* ARRAY_CONTAINS */ === n ? new Zt(t, e) : "in" /* IN */ === n ? new Xt(t, e) : "not-in" /* NOT_IN */ === n ? new tn(t, e) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new nn(t, e) : new Gt(t, n, e);
    }
    static R(t, n, e) {
        return "in" /* IN */ === n ? new Yt(t, e) : new Kt(t, e);
    }
    matches(t) {
        const n = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== n && this.V(xt(n, this.value)) : null !== n && Ft(this.value) === Ft(n) && this.V(xt(n, this.value));
...
/** A Filter that implements the array-contains operator. */ class Zt extends Gt {
    ...
    matches(t) {
        const n = t.data.field(this.field);
        return Lt(n) && qt(n.arrayValue, this.value);
    }
}
...
/** A Filter that implements the IN operator. */ class Xt extends Gt {
    ...
    matches(t) {
        const n = t.data.field(this.field);
        return null !== n && qt(this.value.arrayValue, n);
    }
}

/** A Filter that implements the not-in operator. */ class tn extends Gt {
    constructor(t, n) {
...
/** A Filter that implements the array-contains-any operator. */ class nn extends Gt {
    constructor(t, n) {
        super(t, "array-contains-any" /* ARRAY_CONTAINS_ANY */ , n);
    }
    matches(t) {
        const n = t.data.field(this.field);
        return !(!Lt(n) || !n.arrayValue.values) && n.arrayValue.values.some((t => qt(this.value.arrayValue, t)));
    }
}
 ...
 */ function fn(t) {
    ...
    if (null === n.D) {
        ...
        t.isKeyField() || n.D.push(new rn(t)), n.D.push(new rn(X.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function dn(t) {
    const n = E(t);
    if (!n.$) if ("F" /* First */ === n.limitType) n.$ = Wt(n.path, n.collectionGroup, fn(n), n.filters, n.limit, n.startAt, n.endAt); else {
        ...
        n.$ = Wt(n.path, n.collectionGroup, t, n.filters, n.limit, e, r);
    }
    return n.$;
}
...
function Cn(t, n) {
    ...
    if (e.get(1) !== t.databaseId.projectId) throw new j(P, "Tried to deserialize key from different project: " + e.get(1) + " vs " + t.databaseId.projectId);
    if (e.get(3) !== t.databaseId.database) throw new j(P, "Tried to deserialize key from different database: " + e.get(3) + " vs " + t.databaseId.database);
    return new tt((b((r = e).length > 4 && "documents" === r.get(4)), r.popFirst(5)));
    var r;
...
function kn(t, n) {
    return "found" in n ? function(t, n) {
        ...
        const e = Cn(t, n.found.name), r = qn(n.found.updateTime), s = new Bt({
            mapValue: {
        ...
        const e = Cn(t, n.missing), r = qn(n.readTime);
...
class Zn extends class {} {
    ...
    J() {
        if (this.K) throw new j(S, "The client has already been terminated.");
    }
...
async function Xn(t, n) {
    const e = E(t), r = Un(e.S) + "/documents", s = {
        writes: n.map((t => Mn(e.S, t)))
    };
...
function re(t) {
    ...
    if (!ee.has(t)) {
        ...
        new H(n, e, r, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams))), o = Kn(t._databaseId), u = function(t, n, e) {
            return new Zn(t, n, e);
        }(t._credentials, i, o);
        ee.set(t, u);
    }
...
class se {
    constructor(t) {
        ...
        this.useFetchStreams = !!t.useFetchStreams, function(t, n, e, r) {
            if (!0 === n && !0 === r) throw new j(P, `${t} and ${e} cannot be used together.`);
 ...
 */ (t));
    ...
    _setSettings(t) {
        ...
        this._settings = new se(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new B;
            switch (t.type) {
              case "gapi":
                const n = t.client;
 ...
 */ function ce(t, n, e, r = {}) {
    var s;
    const i = (t = it(t, ie))._getSettings();
    ...
    t._setSettings(Object.assign(Object.assign({}, i), {
        ...
        if ("string" == typeof r.mockUserToken) n = r.mockUserToken, e = f.MOCK_USER; else {
            ...
            if (!i) throw new j(P, "mockUserToken must contain 'sub' or 'user_id' field!");
            e = new f(i);
        }
        t._credentials = new Q(new M(n, e));
    }
}
 ...
 * terminated.
 */ function ae(t) {
    return t = it(t, ie), e(t.app, "firestore/lite"), t._delete();
}
...
function de(t, n, ...e) {
    if (t = l(t), nt("collection", "path", n), t instanceof ie) {
        const r = J.fromString(n, ...e);
        return rt(r), new fe(t, /* converter= */ null, r);
    }
    {
        if (!(t instanceof he || t instanceof fe)) throw new j(P, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const r = J.fromString(t.path, ...e).child(J.fromString(n));
        return rt(r), new fe(t.firestore, 
        /* converter= */ null, r);
    }
}
 ...
 */ function we(t, n) {
    if (t = it(t, ie), nt("collectionGroup", "collection id", n), n.indexOf("/") >= 0) throw new j(P, `Invalid collection ID '${n}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new le(t, 
    /* converter= */ null, 
    /**
...
function me(t, n, ...e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = mt.A()), nt("doc", "path", n), t instanceof ie) {
        const r = J.fromString(n, ...e);
        return et(r), new he(t, 
        /* converter= */ null, new tt(r));
    }
    {
        if (!(t instanceof he || t instanceof fe)) throw new j(P, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const r = t._path.child(J.fromString(n, ...e));
        return et(r), new he(t.firestore, t instanceof fe ? t.converter : null, new tt(r));
    }
}
 ...
 * Firestore database.
 */ function ye(t, n) {
    return t = l(t), n = l(n), t instanceof le && n instanceof le && (t.firestore === n.firestore && wn(t._query, n._query) && t.converter === n.converter);
}
 ...
 */ class _e {
     ...
     */
    constructor(...t) {
        for (let n = 0; n < t.length; ++n) if (0 === t[n].length) throw new j(P, "Invalid field name at argument $(i + 1). Field names must not be empty.");
 ...
 */ class ve {
     ...
     */    static fromBase64String(t) {
        try {
            return new ve(Tt.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new ve(Tt.fromUint8Array(t));
    }
    /**
 ...
 */ class Ee {
    ...
    constructor(t, n) {
        ...
        if (!isFinite(n) || n < -180 || n > 180) throw new j(P, "Longitude must be a number between -180 and 180, but was: " + n);
...
/** The result of parsing document data (e.g. for a setData call). */ class Te {
    ...
    toMutation(t, n) {
        return null !== this.fieldMask ? new An(t, this.data, this.fieldMask, n, this.fieldTransforms) : new Tn(t, this.data, n, this.fieldTransforms);
    }
}
...
/** A "context" object passed around while parsing user data. */ class Re {
    ...
    /** Returns a new context with the specified settings overwritten. */    tt(t) {
        return new Re(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.S, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    nt(t) {
        var n;
    ...
    ot(t) {
        return Ge(t, this.settings.methodName, this.settings.ut || !1, this.path, this.settings.ct);
    }
    ...
    rt(t) {
        ...
        if (Pe(this.X) && Ie.test(t)) throw this.ot('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Ve {
    constructor(t, n, e) {
        this.databaseId = t, this.ignoreUndefinedProperties = n, this.S = e || Kn(t);
    }
...
class qe extends be {
    ...
    _toFieldTransform(t) {
        const n = Fe(this, t, 
        /*array=*/ !0), e = this.ht.map((t => je(t, n))), r = new _n(e);
...
class xe extends be {
    ...
    _toFieldTransform(t) {
        const n = Fe(this, t, 
        /*array=*/ !0), e = this.ht.map((t => je(t, n))), r = new gn(e);
        return new bn(t.path, r);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class Oe extends be {
    ...
    _toFieldTransform(t) {
        const n = new vn(t.S, mn(t.S, this.lt));
...
/** Parse update data from a list of field/value arguments. */ function Le(t, n, e, r, s, i) {
    const o = t.at(1 /* Update */ , n, e), u = [ Qe(n, r, e) ], c = [ s ];
    if (i.length % 2 != 0) throw new j(P, `Function ${n}() needs to be called with an even number of arguments that alternate between field names and values.`);
 ...
 */ function Ue(t, n, e, r = !1) {
    return je(e, t.at(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , n));
}
 ...
 */ function je(t, n) {
    ...
    // from firestore-exp.
    t = l(t))) return Be("Unsupported field value:", n, t), ke(t, n);
    if (t instanceof be) 
 ...
 */
    return function(t, n) {
        ...
        if (!Pe(n.X)) throw n.ot(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, n), null;
    ...
    return function(t, n) {
        ...
        if ("number" == typeof t) return mn(n.S, t);
        ...
        if (t instanceof ve) return {
            bytesValue: Fn(n.S, t._byteString)
        };
        if (t instanceof he) {
        ...
        throw n.ot(`Unsupported field value: ${st(t)}`);
    }
    /**
...
function Me(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof _t || t instanceof Ee || t instanceof ve || t instanceof he || t instanceof be);
}
 ...
 */ function Qe(t, n, e) {
    ...
    throw Ge("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, e);
}
 ...
 * evaluated.
 */ function We(t, n, e) {
    if (n.search(ze) >= 0) throw Ge(`Invalid field path (${n}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, e);
    try {
        return new _e(...n.split("."))._internalPath;
    } catch (r) {
        throw Ge(`Invalid field path (${n}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, e);
    }
}

function Ge(t, n, e, r, s) {
 ...
 */ function Ze(t, n) {
    return t = l(t), n = l(n), t instanceof Ye && n instanceof Ye ? t._firestore === n._firestore && t._key.isEqual(n._key) && (null === t._document ? null === n._document : t._document.isEqual(n._document)) && t._converter === n._converter : t instanceof Je && n instanceof Je && (ye(t.query, n.query) && yt(t.docs, n.docs, Ze));
}

/**
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */ function Xe(t, n) {
    return "string" == typeof n ? We(t, n) : n instanceof _e ? n._internalPath : n._delegate._internalPath;
}
    ...
    _apply(t) {
        const n = Ne(t.firestore), e = function(t, n, e, r, s, i, o) {
            ...
            return function(t, n) {
                if (n.N()) {
                    const e = hn(t);
                    if (null !== e && !e.isEqual(n.field)) throw new j(P, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${e.toString()}' and '${n.field.toString()}'`);
                    const r = an(t);
 ...
 */
                ...
                throw e === n.op ? new j(P, `Invalid query. You cannot use more than one '${n.op.toString()}' filter.`) : new j(P, `Invalid query. You cannot use '${n.op.toString()}' filters with '${e.toString()}' filters.`);
            }(t, c), c;
...
class ar extends tr {
    ...
    _apply(t) {
        const n = mr(t, this.type, this.vt, this.bt);
        return new le(t.firestore, t.converter, function(t, n) {
...
/** Helper function to create a bound from a document or fields */ function mr(t, n, e, r) {
    if (e[0] = l(e[0]), e[0] instanceof Ye) return function(t, n, e, r, s) {
        if (!r) throw new j(V, `Can't use a DocumentSnapshot that doesn't exist for ${e}().`);
        const i = [];
        ...
        // results.
            ...
            if (Nt(t)) throw new j(P, 'Invalid query. You are trying to start or end a query using a document for which the field "' + e.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
        ...
        return function(t, n, e, r, s, i) {
            ...
            for (let i = 0; i < s.length; i++) {
                ...
                if (o[i].field.isKeyField()) {
                    ...
                    if (!ln(t) && -1 !== c.indexOf("/")) throw new j(P, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${r}() must be a plain document ID, but '${c}' contains a slash.`);
                    const e = t.path.child(J.fromString(c));
                    if (!tt.isDocumentKey(e)) throw new j(P, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${r}() must result in a valid document path, but '${e}' is not because it contains an odd number of segments.`);
                    const s = new tt(e);
                    u.push(Ct(n, s));
                } else {
                    const t = Ue(e, r, c);
...
function pr(t, n, e) {
    if ("string" == typeof (e = l(e))) {
        if ("" === e) throw new j(P, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!ln(n) && -1 !== e.indexOf("/")) throw new j(P, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${e}' contains a '/' character.`);
    ...
    throw new j(P, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${st(e)}.`);
}
 ...
 * array requirements.
 */ function yr(t, n) {
    if (!Array.isArray(t) || 0 === t.length) throw new j(P, `Invalid Query. A non-empty array is required for '${n.toString()}' filters.`);
    if (t.length > 10) throw new j(P, `Invalid Query. '${n.toString()}' filters support a maximum of 10 elements in the value array.`);
}

function _r(t, n, e) {
    if (!e.isEqual(n)) throw new j(P, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${n.toString()}' and so you must also use '${n.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${e.toString()}' instead.`);
}
...
class vr extends class {
    ...
    convertDocumentKey(t, n) {
        ...
        b(Yn(e));
        const r = new Y(e.get(1), e.get(3)), s = new tt(e.popFirst(5));
        return r.isEqual(n) || 
 ...
 * document contents.
 */ function br(t) {
    const n = re((t = it(t, he)).firestore), e = new vr(t.firestore);
 ...
 */ function Er(t) {
    !function(t) {
        if (cn(t) && 0 === t.explicitOrderBy.length) throw new j(O, "limitToLast() queries require specifying at least one orderBy() clause");
    }((t = it(t, le))._query);
...
function Ir(t, n, e) {
    const r = gr((t = it(t, he)).converter, n, e), s = De(Ne(t.firestore), "setDoc", t._key, r, null !== t.converter, e);
    return Xn(re(t.firestore), [ s.toMutation(t._key, En.none()) ]);
}

function Tr(t, n, e, ...r) {
    const s = Ne((t = it(t, he)).firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        let i;
    i = "string" == typeof (n = l(n)) || n instanceof _e ? Le(s, "updateDoc", t._key, n, e, r) : Ce(s, "updateDoc", t._key, n);
    return Xn(re(t.firestore), [ i.toMutation(t._key, En.exists(!0)) ]);
}
 ...
 */ function Ar(t) {
    return Xn(re((t = it(t, he)).firestore), [ new Pn(t._key, En.none()) ]);
}
 ...
 */ function Pr(t, n) {
    const e = me(t = it(t, fe)), r = gr(t.converter, n), s = De(Ne(t.firestore), "addDoc", e._key, r, null !== e.converter, {});
    return Xn(re(t.firestore), [ s.toMutation(e._key, En.exists(!1)) ]).then((() => e));
}
 ...
 */ class Fr {
    ...
    set(t, n, e) {
        ...
        const r = Sr(t, this._firestore), s = gr(r.converter, n, e), i = De(this._dataReader, "WriteBatch.set", r._key, s, null !== r.converter, e);
...
function Sr(t, n) {
    if ((t = l(t)).firestore !== n) throw new j(P, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 * writes.
 */ function qr(t) {
    const n = re(t = it(t, ie));
    return new Fr(t, (t => Xn(n, t)));
}
...
class Or {
    constructor(t, n, e, r) {
        ...
        this.Et = 5, this.It = new Jn(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
    }
    ...
    Tt() {
        this.It.W((async () => {
            const t = new xr(this.datastore), n = this.At(t);
            n && n.then((n => {
 ...
 */ class Lr {
     ...
     */    cancel(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new j(T, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    handleDelayElapsed() {
...
class jr {
     ...
     */    get(t) {
        const n = Sr(t, this._firestore), e = new vr(this._firestore);
    ...
    set(t, n, e) {
        const r = Sr(t, this._firestore), s = gr(r.converter, n, e), i = De(this._dataReader, "Transaction.set", r._key, s, null !== r.converter, e);
 ...
 */ function kr(t, n) {
    const e = re(t = it(t, ie)), r = new k;
    return new Or(new Ur, e, (e => n(new jr(t, e))), r).run(), r.promise;
}
 ...
 */ !function(t) {
    ...
    const e = t.getProvider("app").getImmediate(), r = new ie(e, new z(t.getProvider("auth-internal")));
    return n && r._setSettings(n), r;
}), "PUBLIC" /* PUBLIC */)), s("firestore-lite", "3.0.1", "node");

export { ve as Bytes, fe as CollectionReference, he as DocumentReference, Ye as DocumentSnapshot, _e as FieldPath, be as FieldValue, ie as Firestore, j as FirestoreError, Ee as GeoPoint, le as Query, tr as QueryConstraint, Ke as QueryDocumentSnapshot, Je as QuerySnapshot, _t as Timestamp, jr as Transaction, Fr as WriteBatch, Pr as addDoc, Dr as arrayRemove, Nr as arrayUnion, de as collection, we as collectionGroup, ce as connectFirestoreEmulator, Ar as deleteDoc, Rr as deleteField, me as doc, ge as documentId, wr as endAt, dr as endBefore, br as getDoc, Er as getDocs, ue as getFirestore, $r as increment, oe as initializeFirestore, ur as limit, cr as limitToLast, ir as orderBy, nr as query, ye as queryEqual, pe as refEqual, kr as runTransaction, Vr as serverTimestamp, Ir as setDoc, m as setLogLevel, Ze as snapshotEqual, lr as startAfter, hr as startAt, ae as terminate, Tr as updateDoc, rr as where, qr as writeBatch };
