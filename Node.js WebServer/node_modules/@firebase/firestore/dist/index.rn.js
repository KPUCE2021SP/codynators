...
import { base64 as u, getUA as h, isSafari as l, isMobileCordova as f, isReactNative as d, isElectron as w, isIE as _, isUWP as m, isBrowserExtension as g, createMockUserToken as y, getModularInstance as p, deepEqual as E } from "@firebase/util";
...
/** A CredentialsProvider that always yields an empty token. */ class G {
    getToken() {
    ...
    start(t, e) {
        ...
        const r = e => {
            t.enqueueRetryable((async () => {
                $("FirebaseCredentialsProvider", "Auth detected"), this.auth = e, this.auth.addAuthTokenListener(this.o), 
 ...
 */ class Gs {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === Gs.Rt(h()) && O("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    ...
    /** Returns true if IndexedDB is available in the current environment. */    static Pt() {
        ...
        // Check the UA string to find out the browser.
                const t = h(), e = Gs.Rt(t), n = 0 < e && e < 10, s = Gs.vt(t), i = 0 < s && s < 4.5;
        // IE 10
     ...
     */    async Dt(t) {
        return this.db || ($("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new j(K.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new Hs(t, s));
            }, s.onupgradeneeded = t => {
...
class er {
    ...
    u) {
        ...
        this.Qe = t => Promise.resolve(), !er.Pt()) throw new j(K.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
 ...
 */ class ar {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        }(e) || n.isEqual(rt.min()) ? this.Fn(t, e) : this.On.bn(t, s).next((i => {
            const r = this.Mn(e, i);
            return (me(e) || ge(e)) && this.Ln(e.limitType, r, s, n) ? this.Fn(t, e) : (x() <= a.DEBUG && $("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), be(e)), 
    ...
    Fn(t, e) {
        return x() <= a.DEBUG && $("QueryEngine", "Using full collection scan to execute query:", be(e)), 
 ...
 */ class Cr {
    constructor(t) {
         ...
         * IDs.
         */
        this.As = new br, this.targetCount = 0, this.Rs = xi.se();
    }
    forEachTarget(t, e) {
...
class Nr {
     ...
     */
    constructor(t, e) {
        this.Ps = {}, this.Le = new X(0), this.Be = !1, this.Be = !0, this.referenceDelegate = t(this), 
        this.ze = new Cr(this);
        this.Ht = new Ei, this.He = function(t, e) {
            return new Sr(t, e);
        }(this.Ht, (t => this.referenceDelegate.bs(t))), this.N = new oi(e), this.Je = new Pr(this.N);
    }
    start() {
    ...
    getMutationQueue(t) {
        ...
        return e || (e = new Vr(this.Ht, this.referenceDelegate), this.Ps[t.toKey()] = e), 
        e;
    }
    getTargetCache() {
        return this.ze;
    ...
    Ss(t, e) {
        return Qs.or(Object.values(this.Ps).map((n => () => n.containsKey(t, e))));
    }
}
...
class {
    ...
    ji(t, e) {
        const n = [ this.Fi, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], s = R(), i = P(), r = {
...
class Bo {
    constructor() {
        this.queries = new Qi((t => Pe(t)), Re), this.onlineState = "Unknown" /* Unknown */ , 
        this.Zr = new Set;
    }
}
...
async function Uo(t, e) {
    ...
    if (r || (i = !0, r = new Lo), i) try {
        ...
        const n = $o(t, `Initialization of query '${be(e.query)}' failed`);
 ...
 */ (t.type, e.type) || this.po(t.doc, e.doc))), this.Po(n);
        const r = e ? this.bo() : [], o = 0 === this.yo.size && this.current ? 1 /* Synced */ : 0 /* Local */ , c = o !== this.mo;
 ...
 */ class nc {
    ...
    s, i, r) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.No = {}, this.xo = new Qi((t => Pe(t)), Re), 
        this.ko = new Map, 
        /**
    ...
    try {
        const t = await function(t, e) {
            ...
            return n.persistence.runTransaction("Reject batch", "readwrite-primary", (t => {
                let s;
                return n.In.lookupMutationBatch(t, e).next((e => (B(null !== e), s = e.keys(), n.In.removeMutationBatch(t, e)))).next((() => n.In.performConsistencyCheck(t))).next((() => n.Qn.bn(t, s)));
            }));
        }
        /**
...
async function Pc(t, e, n, s) {
    const i = q(t), r = await function(t, e) {
        ...
        return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t => s.Xt(t, e).next((e => e ? n.Qn.bn(t, e) : Qs.resolve(null)))));
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e);
    null !== r ? ("pending" === n ? 
 ...
 */ class Oc extends $c {
    ...
    Go(t) {
        const e = ir(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? Pi.withCacheSize(this.cacheSizeBytes) : Pi.DEFAULT;
 ...
 */ class Fc extends Oc {
    ...
    Wo(t) {
        const e = Jr();
        if (!Kr.Pt(e)) throw new j(K.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ class Mc {
    ...
    createRemoteStore(t) {
        ...
        r = Wr.Pt() ? new Wr : new Qr, new ro(e, n, s, i, r);
        var e, n, s, i, r;
...
function ba(t, e, ...n) {
    ...
    {
        if (!(t instanceof Aa || t instanceof Pa)) throw new j(K.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = ht.fromString(t.path, ...n).child(ht.fromString(e));
...
function Va(t, e, ...n) {
    ...
    }
    {
        ...
        return _a(s), new Aa(t.firestore, t instanceof Pa ? t.converter : null, new vt(s));
    }
}
 ...
 * Firestore database.
 */ function Sa(t, e) {
    return t = p(t), e = p(e), (t instanceof Aa || t instanceof Pa) && (e instanceof Aa || e instanceof Pa) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = ko.createAndSchedule(this, t, e, n, (t => this.Pc(t)));
 ...
 */ function Oa(e, n) {
    ...
    if (void 0 !== n.cacheSizeBytes && -1 !== n.cacheSizeBytes && n.cacheSizeBytes < 1048576) throw new j(K.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    return s.initialize({
        options: n
    });
}
...
function Ka(t) {
    ...
    return t._queue.enqueueAndForgetEvenWhileRestricted((async () => {
        try {
            await async function(t) {
                if (!Gs.Pt()) return Promise.resolve();
                const e = t + "main";
                await Gs.delete(e);
