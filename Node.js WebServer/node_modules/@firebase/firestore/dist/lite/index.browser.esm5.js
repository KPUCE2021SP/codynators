...
import { createMockUserToken as p, getModularInstance as d } from "@firebase/util";
 ...
 * limitations under the License.
 */
var y = "9.0.1", v = new l("@firebase/firestore");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var A = "ok", V = "cancelled", D = "unknown", k = "invalid-argument", P = "deadline-exceeded", N = "not-found", F = "permission-denied", O = "unauthenticated", q = "resource-exhausted", j = "failed-precondition", L = "aborted", R = "out-of-range", U = "unimplemented", x = "internal", B = "unavailable", C = /** @class */ function(e) {
    /** @hideconstructor */
    function n(
    /**
    ...
    return t.prototype.getToken = function() {
        ...
        return this.auth ? this.auth.getToken().then((function(e) {
            return e ? (E("string" == typeof e.accessToken), new G(e.accessToken, new m(t.auth.getUid()))) : null;
...
function(t, e, n, r, i, o, a, s) {
    ...
    n.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var a = o[i];
            if (a.indexOf("//") >= 0) throw new C(k, "Invalid segment (" + a + "). Paths must not contain // in them.");
...
}($), Z = /^[_a-zA-Z][_a-zA-Z0-9]*$/, tt = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.construct = function(t, e, r) {
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new C(k, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, a = !1; i < t.length; ) {
            var s = t[i];
            if ("\\" === s) {
                if (i + 1 === t.length) throw new C(k, "Path has trailing escape character: " + t);
                var u = t[i + 1];
                if ("\\" !== u && "." !== u && "`" !== u) throw new C(k, "Path has invalid escape sequence: " + t);
                r += u, i += 2;
            } else "`" === s ? (a = !a, i++) : "." !== s || a ? (r += s, i++) : (o(), i++);
        }
        if (o(), a) throw new C(k, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.emptyPath = function() {
        return new n([]);
    }, n;
 ...
 */
function nt(t, e, n) {
    if (!n) throw new C(k, "Function " + t + "() cannot be called with an empty " + e + ".");
}
 ...
 */ function rt(t) {
    if (!et.isDocumentKey(t)) throw new C(k, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function it(t) {
    if (et.isDocumentKey(t)) throw new C(k, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new C(k, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = ot(t);
        throw new C(k, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function st(t, e) {
    if (e <= 0) throw new C(k, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
 ...
 */
function pt(t) {
    if (void 0 === t) return b("RPC_ERROR", "HTTP error has no status"), D;
    ...
    // https://github.com/googleapis/googleapis/blob/master/google/rpc/code.proto
      ...
      default:
        return t >= 200 && t < 300 ? A : t >= 400 && t < 500 ? j : t >= 500 && t < 600 ? x : D;
    }
}
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 3:
                    throw a = n.sent(), new C(pt(a.status), "Request failed with error: " + a.statusText);

                  case 4:
                    if (!e.ok) throw new C(pt(e.status), "Request failed with error: " + e.statusText);
 ...
 */ var wt = /** @class */ function() {
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new C(k, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new C(k, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new C(k, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new C(k, "Timestamp seconds out of range: " + t);
    }
    /**
...
var Kt = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.R(t, e, r) : new Wt(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Jt(t, r) : "in" /* IN */ === e ? new Zt(t, r) : "not-in" /* NOT_IN */ === e ? new te(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new ee(t, r) : new n(t, e, r);
    }, n.R = function(t, e, n) {
        return "in" /* IN */ === e ? new Yt(t, n) : new Xt(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.V(jt(e, this.value)) : null !== e && Ft(this.value) === Ft(e) && this.V(jt(e, this.value));
...
}(Kt), Yt = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* IN */ , n) || this).keys = $t("in" /* IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
...
}(Kt), Xt = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "not-in" /* NOT_IN */ , n) || this).keys = $t("not-in" /* NOT_IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** Filter that matches on key fields (i.e. '__name__'). */ function $t(t, e) {
    var n;
 ...
 */ function le(t) {
    ...
    if (null === e.D) {
        ...
        n.isKeyField() || e.D.push(new re(n)), e.D.push(new re(tt.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */ function he(t) {
    var e = I(t);
    if (!e.$) if ("F" /* First */ === e.limitType) e.$ = Ht(e.path, e.collectionGroup, le(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        ...
        // Now return as a LimitType.First query.
                e.$ = Ht(e.path, e.collectionGroup, n, e.filters, e.limit, s, u);
    }
    return e.$;
}
...
}(), _e = function() {}, Se = /** @class */ function(e) {
    function n(t, n, r, i) {
        void 0 === i && (i = []);
        var o = this;
...
function je(t, e) {
    ...
    if (r.get(1) !== t.databaseId.projectId) throw new C(k, "Tried to deserialize key from different project: " + r.get(1) + " vs " + t.databaseId.projectId);
    if (r.get(3) !== t.databaseId.database) throw new C(k, "Tried to deserialize key from different database: " + r.get(3) + " vs " + t.databaseId.database);
 ...
 */ var He = /** @class */ function() {
    ...
    return t(n, e), n.prototype.J = function() {
        if (this.K) throw new C(j, "The client has already been terminated.");
    }, 
...
function We(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = I(t), i = Re(e.S) + "/documents", o = {
                ...
                return a = n.sent(), s = new Map, a.forEach((function(t) {
                    var n = function(t, e) {
                        return "found" in e ? function(t, e) {
                            ...
                            var n = je(t, e.found.name), r = Fe(e.found.updateTime), i = new Gt({
                                mapValue: {
            ...
            switch (n.label) {
              case 0:
                return e = I(t), i = function(t, e) {
                    ...
                    return null !== a && (n.structuredQuery.limit = a), e.startAt && (n.structuredQuery.startAt = xe(e.startAt)), 
                    e.endAt && (n.structuredQuery.endAt = xe(e.endAt)), n;
                }(e.S, he(r)), [ 4 /*yield*/ , e.v("RunQuery", i.parent, {
              ...
              case 1:
                return [ 2 /*return*/ , n.sent().filter((function(t) {
                    ...
                    return function(t, e, n) {
                        var r = je(t, e.name), i = Fe(e.updateTime), o = new Gt({
                            mapValue: {
                                fields: e.fields
                            }
 ...
 */ function Je(t) {
    if (t._terminated) throw new C(j, "The client has already been terminated.");
    if (!$e.has(t)) {
 ...
 */ var Ze = /** @class */ function() {
    function t(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new C(k, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new C(k, "cacheSizeBytes must be at least 1048576");
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
        this.useFetchStreams = !!t.useFetchStreams, function(t, e, n, r) {
            if (!0 === e && !0 === r) throw new C(k, "experimentalForceLongPolling and experimentalAutoDetectLongPolling cannot be used together.");
    ...
    function t(t, e) {
        ...
        this._databaseId = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new C(k, '"projectId" not provided in firebase.initializeApp.');
    ...
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this._app) throw new C(j, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this._app;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this._settingsFrozen) throw new C(j, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this._settings = new Ze(t), void 0 !== t.credentials && (this._credentials = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new C(k, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */ function en(t, e) {
    ...
    if (n.isInitialized()) throw new C(j, "Firestore can only be initialized once per app.");
    return n.initialize({
        options: e
    });
}
 ...
 */ function rn(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        if ("string" == typeof r.mockUserToken) a = r.mockUserToken, s = m.MOCK_USER; else {
            ...
            if (!u) throw new C(k, "mockUserToken must contain 'sub' or 'user_id' field!");
            s = new m(u);
        }
 ...
 */ function cn(t, e) {
    ...
    if (t = d(t), nt("collection", "path", e), t instanceof tn) {
        var o = J.fromString.apply(J, r([ e ], n));
        return it(o), new un(t, /* converter= */ null, o);
    }
    if (!(t instanceof an || t instanceof un)) throw new C(k, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var a = J.fromString.apply(J, r([ t.path ], n)).child(J.fromString(e));
 ...
 */ function fn(t, e) {
    if (t = at(t, tn), nt("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new C(k, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new sn(t, 
    /* converter= */ null, 
    /**
...
function ln(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = yt.A()), nt("doc", "path", e), t instanceof tn) {
        var o = J.fromString.apply(J, r([ e ], n));
 ...
 * Firestore database.
 */ function hn(t, e) {
    return t = d(t), e = d(e), (t instanceof an || t instanceof un) && (e instanceof an || e instanceof un) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
var dn = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new C(k, "Invalid field name at argument $(i + 1). Field names must not be empty.");
 ...
 */ var yn = /** @class */ function() {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            ...
            throw new C(k, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
...
function(t) {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new C(k, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new C(k, "Longitude must be a number between -180 and 180, but was: " + e);
    ...
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Te(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Se(t, this.data, e, this.fieldTransforms);
    }, t;
}(), _n = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var Tn = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.tt = function(e) {
        ...
        return Gn(t, this.settings.methodName, this.settings.ut || !1, this.path, this.settings.ct);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Sn(this.X) && wn.test(t)) throw this.ot('Document fields cannot begin and end with "__"');
    }, t;
}(), En = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.S = n || ze(t)
...
/** Parse document data from a set() call. */ function An(t, e, n, r, i, o) {
    ...
    var s, u, c = Rn(r, a);
    if (o.merge) s = new Tt(a.fieldMask), u = a.fieldTransforms; else if (o.mergeFields) {
        for (var f = [], l = 0, h = o.mergeFields; l < h.length; l++) {
            var p = Bn(e, h[l], n);
            if (!a.contains(p)) throw new C(k, "Field '" + p + "' is specified in your field mask but missing from your input data.");
            Qn(f, p) || f.push(p);
        }
        s = new Tt(f), u = a.fieldTransforms.filter((function(t) {
...
var kn = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new ge(t.S, pe(t.S, this.lt));
...
/** Parse update data from a list of field/value arguments. */ function qn(t, e, n, r, i, o) {
    var a = t.at(1 /* Update */ , e, n), s = [ Bn(e, r, n) ], u = [ i ];
    if (o.length % 2 != 0) throw new C(k, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) s.push(Bn(e, o[c])), u.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var f = [], l = Gt.empty(), h = s.length - 1; h >= 0; --h) if (!Qn(f, s[h])) {
        var p = s[h], m = u[h];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        m = d(m);
 ...
 */ function jn(t, e, n, r) {
    return void 0 === r && (r = !1), Ln(n, t.at(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Ln(t, e) {
    ...
    // from firestore-exp.
    t = d(t))) return xn("Unsupported field value:", e, t), Rn(t, e);
    if (t instanceof vn) 
    ...
    return function(t, e) {
        ...
        if (!Sn(e.X)) throw e.ot(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return pe(e.S, t);
        ...
        if (t instanceof yn) return {
            bytesValue: Pe(e.S, t._byteString)
        };
        if (t instanceof an) {
        ...
        throw e.ot("Unsupported field value: " + ot(t));
    }(t, e);
}
 ...
 * evaluated.
 */ function Mn(t, e, n) {
    if (e.search(Cn) >= 0) throw Gn("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
 ...
 */
function Wn(t, e) {
    return t = d(t), e = d(e), t instanceof zn && e instanceof zn ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof Kn && e instanceof Kn && pn(t.query, e.query) && gt(t.docs, e.docs, Wn)
    /**
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */;
}
...
function Yn(t, e) {
    return "string" == typeof e ? Mn(t, e) : e instanceof dn ? e._internalPath : e._delegate._internalPath;
}
...
var Jn = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = In(t.firestore), n = function(t, e, n, r, i, o, a) {
            var s;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new C(k, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            var h = Kt.create(i, o, s);
            return function(t, e) {
                if (e.N()) {
                    var n = ce(t);
                    if (null !== n && !n.isEqual(e.field)) throw new C(k, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = ue(t);
 ...
 */
                ...
                throw i === e.op ? new C(k, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new C(k, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, h), h;
...
var tr = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new C(k, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new C(k, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new re(e, n);
            return function(t, e) {
                if (null === ue(t)) {
...
var or = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = lr(t, this.type, this.bt, this.vt);
        return new sn(t.firestore, t.converter, function(t, e) {
...
/** Helper function to create a bound from a document or fields */ function lr(t, e, n, r) {
    if (n[0] = d(n[0]), n[0] instanceof zn) return function(t, e, n, r, i) {
        if (!r) throw new C(N, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        for (var o = [], a = 0, s = le(t); a < s.length; a++) {
            ...
            if (u.field.isKeyField()) o.push(Rt(e, r.key)); else {
                ...
                if (kt(c)) throw new C(k, 'Invalid query. You are trying to start or end a query using a document for which the field "' + u.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var f = u.field.canonicalString();
                    throw new C(k, "Invalid query. You are trying to start or end a query using a document for which the field '" + f + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    return function(t, e, n, r, i, o) {
        ...
        if (i.length > a.length) throw new C(k, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var s = [], u = 0; u < i.length; u++) {
            var c = i[u];
            if (a[u].field.isKeyField()) {
                if ("string" != typeof c) throw new C(k, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!fe(t) && -1 !== c.indexOf("/")) throw new C(k, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var f = t.path.child(J.fromString(c));
                if (!et.isDocumentKey(f)) throw new C(k, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + f + "' is not because it contains an odd number of segments.");
                var l = new et(f);
                s.push(Rt(e, l));
            } else {
                var h = jn(n, r, c);
...
function hr(t, e, n) {
    if ("string" == typeof (n = d(n))) {
        if ("" === n) throw new C(k, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!fe(e) && -1 !== n.indexOf("/")) throw new C(k, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(J.fromString(n));
        if (!et.isDocumentKey(r)) throw new C(k, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Rt(t, new et(r));
    }
    if (n instanceof an) return Rt(t, n._key);
    throw new C(k, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + ot(n) + ".");
}
 ...
 * array requirements.
 */ function pr(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new C(k, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new C(k, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function dr(t, e, n) {
    if (!n.isEqual(e)) throw new C(k, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
 ...
 */ function gr(t) {
    !function(t) {
        if (se(t) && 0 === t.explicitOrderBy.length) throw new C(U, "limitToLast() queries require specifying at least one orderBy() clause");
    }((t = at(t, sn))._query);
...
function br(t, e, n) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        return o = "string" == typeof (e = d(e)) || e instanceof dn ? qn(a, "updateDoc", t._key, e, n, r) : On(a, "updateDoc", t._key, e), 
 ...
 */ function Sr(t, e) {
    var n = ln(t = at(t, un)), r = mr(t.converter, e), i = An(In(t.firestore), "addDoc", n._key, r, null !== n.converter, {});
 ...
 */ var Dr = /** @class */ function() {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = kr(t, this._firestore), i = mr(r.converter, e, n), o = An(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = d(e)) || e instanceof dn ? qn(this._dataReader, "WriteBatch.update", a._key, e, n, r) : On(this._dataReader, "WriteBatch.update", a._key, e), 
    ...
    t.prototype.commit = function() {
        ...
        if (this._committed) throw new C(j, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();

function kr(t, e) {
    if ((t = d(t)).firestore !== e) throw new C(k, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ var Nr = /** @class */ function() {
    ...
    return t.prototype.lookup = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new C(k, "Firestore transactions require all reads to be executed before all writes.");
        ...
        if (n) {
            ...
            throw new C(L, "Document version changed between two reads.");
    ...
    t.prototype.preconditionForUpdate = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new C(k, "Can't update a document that doesn't exist.");
    ...
    function t(t, e, n, r) {
        ...
        this.Et = 5, this.It = new He(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.It.W((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new Nr(this.datastore), (e = this.At(t)) && e.then((function(e) {
 ...
 */ var qr = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new C(V, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    t.prototype.Ut = function() {
        ...
        var e = this, n = this.Vt.then((function() {
            return e.St = !0, t().catch((function(t) {
                ...
                throw e.Ft = t, e.St = !1, b("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
    ...
    return t.prototype.get = function(t) {
        ...
        var r = kr(t, this._firestore), i = mr(r.converter, e, n), o = An(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = d(e)) || e instanceof dn ? qn(this._dataReader, "Transaction.update", a._key, e, n, r) : On(this._dataReader, "Transaction.update", a._key, e), 
...
y = s + "_lite", u(new f("firestore/lite", (function(t, e) {
    var n = e.options, r = t.getProvider("app").getImmediate(), i = new tn(r, new H(t.getProvider("auth-internal")));
    return n && i._setSettings(n), i;
}), "PUBLIC" /* PUBLIC */)), c("firestore-lite", "3.0.1", "node");

export { yn as Bytes, un as CollectionReference, an as DocumentReference, zn as DocumentSnapshot, dn as FieldPath, vn as FieldValue, tn as Firestore, C as FirestoreError, gn as GeoPoint, sn as Query, Xn as QueryConstraint, Hn as QueryDocumentSnapshot, Kn as QuerySnapshot, wt as Timestamp, Lr as Transaction, Dr as WriteBatch, Sr as addDoc, Ar as arrayRemove, Ir as arrayUnion, cn as collection, fn as collectionGroup, rn as connectFirestoreEmulator, _r as deleteDoc, Tr as deleteField, ln as doc, mn as documentId, fr as endAt, cr as endBefore, vr as getDoc, gr as getDocs, nn as getFirestore, Vr as increment, en as initializeFirestore, rr as limit, ir as limitToLast, er as orderBy, $n as query, pn as queryEqual, hn as refEqual, Rr as runTransaction, Er as serverTimestamp, wr as setDoc, g as setLogLevel, Wn as snapshotEqual, sr as startAfter, ar as startAt, on as terminate, br as updateDoc, Zn as where, Pr as writeBatch };
